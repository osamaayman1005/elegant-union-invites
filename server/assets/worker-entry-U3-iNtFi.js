...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-RK_Jn1XY.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C5JCUT6Q.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "elegant-union-invites";
var SERVER_FN_BASE = "/elegant-union-invites/_serverFn/";
